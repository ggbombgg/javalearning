...
# [5.分隔线 删除线 下划线 脚注](#5分隔线-删除线-下划线-脚注用法)
# [6.列表](#6markdown列表)
# [7.区块](#7markdown区块)
# [8.代码](#8markdown代码)
# [9.链接](#9链接-)
...
///////////
真烦，遇到很多问题，笔记写得也很烂，一方面是github不熟悉，另一方是markdown不熟悉,还有就是自己从小到大很少记笔记，搞得很乱，现在还有很多问题，不想改了。除了条理性逻辑啥的，还有如下：
* 直接在主分支进行无限次更改，这是不好的
* 在标题中喜欢添加解释，而不是写到内容
* 目录跳转对于目录和标题名相同会直接跳目录，标题有-#()等符号，我无法进行跳转，我暂时没有解决方法，也不想解决
* 目录里面的小目录罗列不想写了
